...
def start():
    ...
    # scheduler.add_job(fetch_trending_content, 'interval', seconds=10)
    # scheduler.add_job(remove_not_trending_content, 'interval', seconds=10)
    ...
    # scheduler.add_job(remove_released_content, 'interval', seconds=10)
    scheduler.start()
